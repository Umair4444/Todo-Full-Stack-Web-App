...
- Package Management Protocol: Using npm for TypeScript, uv for Python dependencies
- Virtual Environment Requirement: Activating Python virtual environment before package operations
- Test-Driven Development: Following TDD practices with Red-Green-Refactor cycle
